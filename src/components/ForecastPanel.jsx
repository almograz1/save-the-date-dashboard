  ...
  return (
    <div>
      ...
      <p className="panel-subtitle">
        ...
        the NDVI peak is the maximum of an Ordinary-Kriging seasonal curve;
        irrigation timing is a Universal-Kriging projection of the recent NDMI
      ...
      <div className="forecast-grid">
          ...
          {irrigation ? (
            <>
              ...
              <div className="forecast-detail">
                Current NDMI: {irrigation.currentNdmi.toFixed(3)} ·{' '}
                {irrigation.status === 'adequate'
              ...
              <div className="forecast-note">
                ...
                {irrigation.ndmiSlope.toFixed(4)} NDMI / observation
              </div>
            </>
          ) : (
        ...
        <div className="forecast-card">
          <div className="forecast-card-header">
            <span className="forecast-icon">🌴</span>
            <span className="forecast-card-title">Next NDVI Peak (Harvest Window)</span>
          </div>
          {harvest ? (
            <>
              ...
              <div className="forecast-detail">
                Predicted peak NDVI: {harvest.peakNdvi.toFixed(3)} (95% CI{' '}
