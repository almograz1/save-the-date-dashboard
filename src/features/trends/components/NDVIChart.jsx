  ...
  return (
    <div className="ndvi-tooltip">
      ...
      <div className="ndvi-tooltip-row meta">
        <span>Vegetation Health range</span>
        <span className="val">
  ...
  return (
    <div>
      <div className="ndvi-chart-header">
        <div>
          <h2 className="panel-title">Vegetation Health (NDVI) &amp; Soil Moisture Over Time</h2>
          <p className="panel-subtitle">
            Vegetation health (green) tracking soil moisture (blue). When the
            two move together, irrigation is driving growth.
          </p>
        </div>
        <button
      ...
      <ResponsiveContainer width="100%" height={340}>
        ...
        >
          ...
          <Area
            ...
            stroke="none"
            fillOpacity={0.3}
            name="Vegetation health range (NDVI)"
          />
          <Line
            yAxisId="ndvi"
            type="monotone"
